                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <a class="flex items-center space-x-3 border-l pl-4 border-gray-200">
                        ...
                        <div class="p-1.5 space-y-1">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link
                                    ...
                                    class="flex items-center space-x-2.5 px-3 py-2 rounded-xl text-xs font-extrabold text-rose-600 hover:text-rose-700 hover:bg-rose-50/60 transition-all duration-150"
                                >
