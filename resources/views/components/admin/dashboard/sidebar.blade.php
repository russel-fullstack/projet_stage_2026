<aside class="w-64 bg-[#F8FAFC] border-r border-gray-200 hidden md:flex flex-col justify-between p-4">
    <div class="space-y-6">
        ...
        <nav class="space-y-1">
            ...
            <!-- Gestion des cours -->
            <a href="{{ route('list-courses.index') }}"
               class="flex items-center space-x-3 px-4 py-3 text-xs font-bold rounded-xl transition-all {{ request()->routeIs('list-courses.*') ? 'bg-emerald-400 text-primary shadow-sm shadow-emerald-400/30' : 'text-slate hover:bg-gray-100 hover:text-gray-900' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ route('programs.index') }}"
               class="flex items-center space-x-3 px-4 py-3 text-xs font-bold rounded-xl transition-all {{ request()->routeIs('programs.*') ? 'bg-emerald-400 text-primary shadow-sm shadow-emerald-400/30' : 'text-slate hover:bg-gray-100 hover:text-gray-900' }}">
                {{-- Icône de graphique/rapports corrigée --}}
            ...
            <a href="{{ route('specialties.index') }}"
               class="flex items-center space-x-3 px-4 py-3 text-xs font-bold rounded-xl transition-all {{ request()->routeIs('specialties.*') ? 'bg-emerald-400 text-primary shadow-sm shadow-emerald-400/30' : 'text-slate hover:bg-gray-100 hover:text-gray-900' }}">
                {{-- Icône de graphique/rapports corrigée --}}
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
