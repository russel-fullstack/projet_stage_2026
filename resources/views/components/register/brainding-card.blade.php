<div class="hidden lg:flex bg-primary border-b border-b-secondary relative overflow-hidden p-10 sm:p-12 lg:p-16 flex-col justify-between text-white h-full">
    ...
    <div class="relative z-10 space-y-8 my-auto">
        ...
        <div class="inline-flex items-center space-x-2 px-3.5 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-full">
            ...
            <span class="text-xs font-black uppercase tracking-wider text-emerald-300">Community Trusted</span>
        </div>
        ...
        <!-- Cartes statistiques -->
        <div class="grid grid-cols-2 gap-4 pt-2 max-w-md">
            <div class="p-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
                ...
                <p class="text-xs font-semibold text-slate-400 mt-1">Cours Experts</p>
            </div>
            <div class="p-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
                <p class="text-2xl font-black text-emerald-400">100%</p>
                <p class="text-xs font-semibold text-slate-400 mt-1">Gratuit À Vie</p>
            </div>
        </div>
    </div>
    ...
    <div class="relative z-10 pt-8 border-t border-white/10 flex items-center space-x-4">
        ...
        <p class="text-xs font-semibold text-slate-300">
            Rejoint par des étudiants d'écoles et entreprises de renom.
        </p>
    </div>
</div>
