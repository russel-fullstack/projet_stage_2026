...
<div class="relative mb-4">
    ...
    <div class="relative flex justify-center text-xs uppercase"><span class="bg-white px-3 text-slate-400 font-bold text-[10px] tracking-wider">Ou s'inscrire avec</span></div>
</div>
