<x-layouts.admin.admin-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <x-admin.dashboard.stat-card title="Utilisateurs Totaux" value="{{ count(\App\Models\User::all()) }}" trend="+12% ce mois" >
        ...
        <x-admin.dashboard.stat-card title="Cours Publiés" value="{{ count($courses) }}" trend="24 nouveaux" iconColor="bg-emerald-50 text-emerald-600">
