            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-xs mt-2 text-slate-700">
                        ...
                        <button form="send-verification" class="underline text-xs text-slate-500 hover:text-[#110B29] rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#110B29]/20">
