                ...
                <div class="flex items-center gap-2">
                  ...
                  <div class="ml-3">
                      ...
                      <p class="text-sm text-slate-500 ">
                          Renseignez les détails pour créer une spécialité et l'associer à une filière.
                      </p>
                  </div>
                </div>
            </div>
            ...
            >
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        >
                            <option value="" disabled {{ old('program_id', request('program')) ? '' : 'selected' }}>
                            ...
                            @foreach ($programs as $program)
                                <option
                                    value="{{ $program->id }}"
                                    @selected(old('program_id', request('program')) == $program->id)
                                >
                                    {{ $program->name }}
                                </option>
                            @endforeach
                ...
                <div>
                    ...
                    <input
                        ...
                        name="name"
                        value="{{ old('name') }}"
                        placeholder="Ex : Génie Logiciel, Web & Mobile, SGBD..."
                        required
                ...
                <div>
                    ...
                    <textarea
                        ...
                        name="description"
                        rows="5"
                        placeholder="Présentez les spécificités, compétences visées ou débouchés de cette spécialité..."
